...
name_MANAGER = "SECURITYCONTROL"

path_PROJECT = os.path.dirname(os.path.realpath(__file__))
path_MANAGER = os.path.join(path_PROJECT + r"\data\m_SecurityControl")
...
class manager_SecurityControl:
    def __init__(self, PST):
        ...
        self.IPC.write_SystemMessage("Initializing SECURITY CONTROL Manager...")
        self.IPC.write_SystemMessage("  Inter-Processes Communicator Initialized!")

        #IPC Files Creation
        f = open(os.path.join(path_MANAGER, 'IPCLog_SECURITYCONTROL.txt'), 'w'); f.close()
        self.IPC.write_SystemMessage("  Inter-Processes Communication Log File Created!: 'IPCLog_SECURITYCONTROL.txt'")
        f = open(os.path.join(path_MANAGER, 'IPCRuntime_SECURITYCONTROL.txt'), 'w'); f.close()
        self.IPC.write_SystemMessage("  Inter-Processes Communication Run Time Data File Created!: 'IPCRuntime_SECURITYCONTROL.txt'")

        
        self.IPC.write_SystemMessage("SECURITY CONTROL Manager Initialization Complete!")
